...
const HiddenComponent = ({setBlurr}) => {
  ...
  return (
    <div style={{ display: visible ? 'block' : 'none' }} className='absolute top-0 left-0 w-screen h-screen  grid place-content-center overflow-hidden'>
      <div className='  w-full  h-full   grid place-items-center'>
        <div className=' w-9/12 h-5/6 rounded-xl bg-zinc-100 grid grid-rows-6 grid-col-1 px-6 py-4'>
            <div className='px-4  pt-4'><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={` row-span-4 flex flex-col  text-8xl font-bold px-3 ${teko.className} leading-[4.5rem] flex justify-center`}>
              <h1>WE CREATE</h1>
              <h1>EYE-OPENING</h1>
              <h1>PRESENTATIONS</h1>
            </div>
            <div className='flex px-4 items-center justify-between'>
              <h1>Loading .....</h1>
              <div className={`${teko.className} text-7xl`}>{count}%</div>
            </div>
        </div>
      </div>
    </div>
